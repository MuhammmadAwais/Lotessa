    ...
    <section className="bg-white ">
      <div className="container mx-auto px-4 py-24 sm:py-22 flex flex-col-reverse lg:flex-row items-center lg:gap-16">
        ...
        <div className="flex-1 text-center lg:text-left mt-12 lg:mt-0">
          ...
          {/* Subtitle: "Track. Learn. Connect." */}
          {subtitle && (
            <p className="mt-4 text-2xl lg:text-3xl font-medium text-gray-700 ">
              {subtitle}
            </p>
          )}
        ...
        {/* Right Side - Image */}
        {/* Removed rounded-lg and shadow-lg from the img tag itself, as the phone mockups provide their own visuals */}
